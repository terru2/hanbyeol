	...
	<div class="container-fluid" style="height:100%; padding: 0;">
		<div id="myCarousel" class="carousel slide" data-ride="carousel" style="height:100%;">
			...
			<div class="carousel-inner" style="height:100%;">
				<div class="item active" style="margin-top: 5%">
					<div style="width: 60%;margin: auto;text-align: right;">
						<h1 style="color: white; margin-top: 0;"><strong>공용시설 안내 서비스</strong></h1>
					</div>
					<div style="border: 6px solid white; width:60%; margin: auto; padding: 2%;">
						<h1 style="color: white;">
							<strong>
								<span class="glyphicon glyphicon-cog"></span> 공용시설 안내 서비스 ?
							</strong>
						</h1>
						<p class="lead" style="color: white; margin-top: 30px;">
							<strong>여러분 누구나 경험 했을 것이라고 생각했습니다.</strong>
						</p>
						<p style="color: white;">
							...
							<strong>저희는 이러한 경험들로부터 다양한 공용시설과 그 정보들을 한번에 알 수 있는 서비스 입니다.</strong><br><br>
						</p>
				...
				<div class="item" style="margin-top: 5%">
					...
					<div style="border: 6px solid white; width:60%; margin: auto; padding: 2%;">
						<h1 style="color: white;">
							<strong>
								<span class="glyphicon glyphicon-search"></span> 시설과 위치 검색 ?
							</strong>
						</h1>
						<p class="lead" style="color: white; margin-top: 20px;">
							<strong>원하는 시설의 위치를 한눈에 볼 수 있습니다.</strong>
						</p>
						<p style="color: white;">
							<br>
							...
							<strong>시설들의 위치를 지도를 통해 한눈에 볼 수 있으며 리스트로 확인 가능합니다.</strong><br><br>
						</p>
						<p class="text-right" style="color: white;">
							2/4
						</p>
				...
				<div class="item" style="margin-top: 5%">
					...
					<div style="border: 6px solid white; width:60%; margin: auto; padding: 2%;">
						<h1 style="color: white;">
							<strong>
								<span class="glyphicon glyphicon-list-alt"></span> 시설의 상세 정보 확인 ?
							</strong>
						</h1>
						<p class="lead" style="color: white; margin-top: 20px;">
							<strong>선택 된 시설의 정보를 확인 할 수 있습니다.</strong>
						</p>
						<p style="color: white;">
							<br>
							...
							<strong>각 시설들의 상세 정보들은 물론 평점 및 댓글을 통해 보다 나은 정보를 제공합니다.</strong><br><br>
						</p>
						<p class="text-right" style="color: white;">
							3/4
						</p>
				...
				<div class="item" style="margin-top: 5%">
					...
					<div style="border: 6px solid white; width:60%; margin: auto; padding: 2%;">
						<h1 style="color: white;">
							<strong>
								<span class="glyphicon glyphicon-map-marker"></span> 나만의 위치 추가 ?
							</strong>
						</h1>
						<p class="lead" style="color: white; margin-top: 20px;">
							<strong>본인만이 알고 있거나 기억 할 장소를 추가 할 수 있습니다.</strong>
						</p>
						<p style="color: white;">
							<br>
							...
							<strong>회원만의 장소를 추가하고 공유 요청 시 전체 시설 데이터에 저장되어 확인 할 수 있습니다.</strong><br><br>
						</p>
						<p class="text-right" style="color: white;">
							4/4
						</p>
		...
		<div style="position: absolute; bottom: 10%; left: 50%; margin-left: -174px">
			<p class="text-center" style="color: white;">서비스를 시작하세요</p>
